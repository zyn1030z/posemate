...
/// The authenticated user's profile.
 AuthUserModel get user;/// Bearer token for subsequent API calls.
 String get accessToken;/// Rotating token used to obtain fresh access tokens, when issued.
 String? get refreshToken;/// Absolute expiry of the access token, when the server includes it.
...
@useResult
$Res call({
 AuthUserModel user, String accessToken, String? refreshToken, DateTime? expiresAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AuthUserModel user,  String accessToken,  String? refreshToken,  DateTime? expiresAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AuthUserModel user,  String accessToken,  String? refreshToken,  DateTime? expiresAt)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel():
return $default(_that.user,_that.accessToken,_that.refreshToken,_that.expiresAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AuthUserModel user,  String accessToken,  String? refreshToken,  DateTime? expiresAt)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
return $default(_that.user,_that.accessToken,_that.refreshToken,_that.expiresAt);case _:
  return null;
...
class _AuthResponseModel implements AuthResponseModel {
  const _AuthResponseModel({required this.user, required this.accessToken, this.refreshToken, this.expiresAt});
